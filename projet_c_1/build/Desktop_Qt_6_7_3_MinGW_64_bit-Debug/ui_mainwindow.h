...
"   "));
        ...
        placeholderClient = new QLabel(pageClient);
        placeholderClient->setObjectName("placeholderClient");
        placeholderClient->setStyleSheet(QString::fromUtf8("font-size: 18px; color: #888; padding: 50px;"));
        placeholderClient->setAlignment(Qt::AlignmentFlag::AlignCenter);

        verticalLayout_3->addWidget(placeholderClient);
        ...
        productionTable->setHorizontalHeaderItem(0, __qtablewidgetitem);
        QTableWidgetItem *__qtablewidgetitem1 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(1, __qtablewidgetitem1);
        QTableWidgetItem *__qtablewidgetitem2 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(2, __qtablewidgetitem2);
        QTableWidgetItem *__qtablewidgetitem3 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(3, __qtablewidgetitem3);
        QTableWidgetItem *__qtablewidgetitem4 = new QTableWidgetItem();
        productionTable->setHorizontalHeaderItem(4, __qtablewidgetitem4);
        ...
        formLayout->addItem(spacerItem3);
        ...
        vboxLayout1 = new QVBoxLayout(cardOlives);
        ...
        vboxLayout1->addWidget(labelOlives);
        ...
        vboxLayout1->addWidget(valueOlives);
        ...
        vboxLayout2 = new QVBoxLayout(cardHuile);
        ...
        vboxLayout3 = new QVBoxLayout(cardRendement);
        ...
        vboxLayout3->addWidget(labelRendement1);
        ...
        vboxLayout3->addWidget(valueRendement);
        ...
        tab2Layout->addItem(spacerItem4);
        ...
        vboxLayout4 = new QVBoxLayout(predResult);
        ...
        vboxLayout4->addWidget(valuePredRendement);
        ...
        vboxLayout4->addWidget(valuePredHuile);
        ...
        tab3Layout->addItem(spacerItem5);
        ...
        anomalyTable->setHorizontalHeaderItem(0, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        anomalyTable->setHorizontalHeaderItem(1, __qtablewidgetitem6);
        QTableWidgetItem *__qtablewidgetitem7 = new QTableWidgetItem();
        anomalyTable->setHorizontalHeaderItem(2, __qtablewidgetitem7);
        QTableWidgetItem *__qtablewidgetitem8 = new QTableWidgetItem();
        anomalyTable->setHorizontalHeaderItem(3, __qtablewidgetitem8);
        QTableWidgetItem *__qtablewidgetitem9 = new QTableWidgetItem();
        anomalyTable->setHorizontalHeaderItem(4, __qtablewidgetitem9);
        ...
        vboxLayout5 = new QVBoxLayout(partnersListTab);
        vboxLayout5->setSpacing(15);
        ...
        partnersTable->setHorizontalHeaderItem(0, __qtablewidgetitem10);
        QTableWidgetItem *__qtablewidgetitem11 = new QTableWidgetItem();
        partnersTable->setHorizontalHeaderItem(1, __qtablewidgetitem11);
        QTableWidgetItem *__qtablewidgetitem12 = new QTableWidgetItem();
        partnersTable->setHorizontalHeaderItem(2, __qtablewidgetitem12);
        QTableWidgetItem *__qtablewidgetitem13 = new QTableWidgetItem();
        partnersTable->setHorizontalHeaderItem(3, __qtablewidgetitem13);
        QTableWidgetItem *__qtablewidgetitem14 = new QTableWidgetItem();
        partnersTable->setHorizontalHeaderItem(4, __qtablewidgetitem14);
        ...
        vboxLayout6 = new QVBoxLayout(formFramePartenaire);
        vboxLayout6->setSpacing(12);
        ...
        vboxLayout6->addWidget(typeComboBox);

        statusLabel = new QLabel(formFramePartenaire);
        statusLabel->setObjectName("statusLabel");

        vboxLayout6->addWidget(statusLabel);
        ...
        vboxLayout6->addWidget(statusComboBox);

        spacerItem7 = new QSpacerItem(0, 20, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        vboxLayout7 = new QVBoxLayout(statsTab);
        vboxLayout7->setSpacing(20);
        ...
        vboxLayout7->addWidget(statsHeaderLabel);
        ...
        vboxLayout8 = new QVBoxLayout(cardTotalPartenaires);
        ...
        vboxLayout8->addWidget(labelTotalPartenaires);
        ...
        vboxLayout8->addWidget(valueTotalPartenaires);
        ...
        vboxLayout9 = new QVBoxLayout(cardActifs);
        ...
        vboxLayout9->addWidget(labelActifs);
        ...
        vboxLayout9->addWidget(valueActifs);
        ...
        vboxLayout10 = new QVBoxLayout(cardInactifs);
        ...
        vboxLayout10->addWidget(labelInactifs);
        ...
        vboxLayout10->addWidget(valueInactifs);


        statsCardsLayout->addWidget(cardInactifs);


        vboxLayout7->addLayout(statsCardsLayout);
        ...
        vboxLayout11 = new QVBoxLayout(mailingTab);
        ...
        vboxLayout11->addWidget(mailingHeaderLabel);

        mailingFrame = new QFrame(mailingTab);
        mailingFrame->setObjectName("mailingFrame");
        vboxLayout12 = new QVBoxLayout(mailingFrame);
        vboxLayout12->setSpacing(15);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        placeholderClient->setText(QCoreApplication::translate("MainWindow", "\360\237\221\244 Module Clients - \303\200 impl\303\251menter", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem = productionTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("MainWindow", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = productionTable->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("MainWindow", "Date", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = productionTable->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("MainWindow", "Qt\303\251 Olives (kg)", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = productionTable->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("MainWindow", "Qt\303\251 Huile (L)", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = productionTable->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("MainWindow", "Rendement (%)", nullptr));
        ...
        QTableWidgetItem *___qtablewidgetitem5 = anomalyTable->horizontalHeaderItem(0);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("MainWindow", "ID", nullptr));
        QTableWidgetItem *___qtablewidgetitem6 = anomalyTable->horizontalHeaderItem(1);
        ___qtablewidgetitem6->setText(QCoreApplication::translate("MainWindow", "Date", nullptr));
        QTableWidgetItem *___qtablewidgetitem7 = anomalyTable->horizontalHeaderItem(2);
        ___qtablewidgetitem7->setText(QCoreApplication::translate("MainWindow", "Rendement (%)", nullptr));
        QTableWidgetItem *___qtablewidgetitem8 = anomalyTable->horizontalHeaderItem(3);
        ___qtablewidgetitem8->setText(QCoreApplication::translate("MainWindow", "\303\211cart (%)", nullptr));
        QTableWidgetItem *___qtablewidgetitem9 = anomalyTable->horizontalHeaderItem(4);
        ...
        QTableWidgetItem *___qtablewidgetitem10 = partnersTable->horizontalHeaderItem(0);
        ___qtablewidgetitem10->setText(QCoreApplication::translate("MainWindow", "Nom", nullptr));
        QTableWidgetItem *___qtablewidgetitem11 = partnersTable->horizontalHeaderItem(1);
        ___qtablewidgetitem11->setText(QCoreApplication::translate("MainWindow", "Email", nullptr));
        QTableWidgetItem *___qtablewidgetitem12 = partnersTable->horizontalHeaderItem(2);
        ___qtablewidgetitem12->setText(QCoreApplication::translate("MainWindow", "T\303\251l\303\251phone", nullptr));
        QTableWidgetItem *___qtablewidgetitem13 = partnersTable->horizontalHeaderItem(3);
        ___qtablewidgetitem13->setText(QCoreApplication::translate("MainWindow", "Type", nullptr));
        QTableWidgetItem *___qtablewidgetitem14 = partnersTable->horizontalHeaderItem(4);
