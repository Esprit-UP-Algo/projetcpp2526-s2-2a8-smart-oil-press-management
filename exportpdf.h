...
private:
    ...
    void dessinerTableau (QPainter &p, int W, int H, int &currentY, QTableWidget *table, QPrinter &printer);
    void dessinerPiedPage(QPainter &p, int W, int H, int pageNumber);
};
